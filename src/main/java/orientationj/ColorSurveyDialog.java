...
public class ColorSurveyDialog {
	...
	public ColorSurveyDialog(OrientationParameters params) {
		
 		GenericDialog gd = new GenericDialog("Color Survey Setting");
 		gd.addChoice("Color representation", new String[] {"HSB", "RGB"}, (params.hsb ? "HSB" : "RGB"));
		...
		params.hsb = (type.equals("HSB") ? true : false);
  	}
