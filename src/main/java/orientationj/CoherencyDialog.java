...
public class CoherencyDialog {
	...
	public CoherencyDialog(OrientationParameters params) {
		
 		GenericDialog gd = new GenericDialog("Coherency Setting");
 		gd.addNumericField("Coherency denominator offset (to avoid division by zero) [\u0395]", params.epsilon, 2);
		...
		double epsilon = gd.getNextNumber();
